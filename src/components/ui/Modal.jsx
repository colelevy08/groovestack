...
export default function Modal({ open, onClose, title, children, width = "480px" }) {
  ...
  return (
    ...
    >
      <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 16, width, maxWidth: "92vw", maxHeight: "88vh", overflow: "auto", boxShadow: "0 32px 80px rgba(0,0,0,0.8)" }}>
