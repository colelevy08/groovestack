// Fixed left navigation sidebar that persists across all screens.
// Contains: app logo, notification bell (with unread count badge), nav links, Add Record + Messages buttons,
// and the current user's avatar/handle at the bottom which links to the Profile screen.
// All state and callbacks come from App.js — this component is purely presentational.

import Avatar from './ui/Avatar';

// Each nav item maps to a screen name (used by App.js nav state) and an SVG icon path.
const NAV_ITEMS = [
